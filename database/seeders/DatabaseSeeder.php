...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $statuses = [ // x = archiválva
            'demand_status' => ['e', 'k', 't', 'x'], //elcserélve, keres, talált
            'book_status' => ['e', 'f', 's', 'x'], //elcserélt, foglalt, szabad
            'exchange_status' => ['a', 'k', 'f', 'v', 'x'] // kezdeményezés, folyamatban, átadva/visszautasítva         
        ];
